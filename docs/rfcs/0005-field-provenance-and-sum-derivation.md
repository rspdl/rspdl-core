...
title: Field Provenance, Screen Usage, and Sum Derivation Grammar
type: rfc
status: implemented
created: 2026-08-03
version: "0.1"
summary: Defines sentence-shaped screen data operations, field provenance checks, cross-model sum dependencies, and explicit recalculation triggers.
topics:
  - data-lifecycle
  - field-provenance
  - screen-usage
...
# Field Provenance, Screen Usage, and Sum Derivation Grammar
