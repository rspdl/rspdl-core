...
- 아직 구현하지 않은 요구사항은 다음과 같다.
  ...
  - conditional data production의 한국어 표면 문법, action input binding, output template field binding, snapshot/retain lifecycle analysis와 structured diagnostic 연결
